...
public class PlayerBobbingMobHologram extends PlayerHoverText
{

	private final List<String> content;

	public PlayerBobbingMobHologram(int entityId, Player player, EntityTrio initialLocation, List<String> content)
	{
